export const ListChart = [
    {
      ...
      SubTitle: (
        <>
          연극인들을 위한 커뮤니티를 만들자는 목적으로 제작되었으며, <br />
          연극을 찾고 홍보할 수 있는 연극 정보 사이트입니다.
        </>
      ),
    ...
    },
    {
      ...
      SubTitle: (
        <>
         모르는 사람과 랜덤 또는 선택하여 채팅할 수 있는 서비스입니다. <br />
         티니박스 프로젝트 중 사이드 프로젝트로 진행하게 되었습니다.
        </>
      ),
      ImageSrc: '/mitch.png',
    ...
    },
    {
      ...
      SubTitle: (
        <>
          반려 식물 및 가드닝 도구를 판매하는 온라인 쇼핑몰 서비스입니다. <br/> 사용자, 상품, 장바구니, 주문, 관리자 관련 기능이 있습니다.
        </>
      ),
